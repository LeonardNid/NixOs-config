...
in
{
  ...
  services.udev.extraRules = ''
    ...
    SUBSYSTEM=="input", ATTRS{idVendor}=="046d", ATTRS{idProduct}=="c08f", GROUP="kvm", MODE="0660"
    ...
    KERNEL=="event*", ATTRS{name}=="LogitechFixed", SYMLINK+="input/logitech-fixed", GROUP="kvm", MODE="0666", TAG+="uaccess"
